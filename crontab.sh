#!/bin/bash
# test crontab.sh to run on my mac, you may need a different one but give it a go
...
# Execute your desired command or script
/Users/seth/dev/redback-pvoutput/redback-pvoutput.sh
